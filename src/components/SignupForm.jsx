...
const SignupForm = () => {
  ...
  // Where to send the user after successful signup.
  // If they arrived here from a protected action (e.g. Login → Signup
  // while trying to save a Meal Plan), go back there. Otherwise, Home.
